...
Source: `market-data-production-docs.html`
...
ADMIN, LEVELONE_EQUITY etc. Please see Service Names table above.
command
Command (required)
...
Unique
identifier
value that is attached to requests and messages that allow reference to a particular transaction or event chain.
parameters
String
Variable
Can leave empty
...
String
Variable
Please see the LEVELONE_EQUITIES Field Definition table below
...
String
Variable
Please see the LEVELONE_OPTIONS Field Definition table below
Response Field Definitions
Streamer Contract name
Type
Length
...
String
Variable
Please see the LEVELONE_FUTURES Field Definition table below
Response Field Definitions
Field
Field Name
Type
...
String
Variable
Please see the LEVELONE_FUTURES_OPTIONS Field Definition table below
Response Field Definitions
Fields
Field Name
Type
...
String
Variable
Please see the LEVELONE_FOREX Field Definition table below
Response Field Definitions
Fields
Field Name
Type
...
String
Variable
Please see the CHART_EQUITY Field Definition table below
Response field definitions
Fields
Field Name
Type
...
String
Variable
Please see the CHART_FUTURES Field Definition table below
